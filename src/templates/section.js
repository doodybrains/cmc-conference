      ...
      <Layout>
        ...
        <div className="grid">
          {title === "computer mouse zine" &&
            <a className="zine" href="https://www.computermouseconference.net/computer-mouse-zine.pdf" target="_blank">Click here to see to zine [pdf version] by Neta Bomani &#8669; &#8669;</a>
          }
          {children
